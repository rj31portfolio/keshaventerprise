  ...
  <div class="page-wrapper">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-7 col-md-6 mt-5 mt-md-0 ps-lg-5">
            <div class="product-details">
              ...
              <p>High-performance NC Press Brake machines designed for precision metal bending. Ideal for sheet metal
                fabrication with user-friendly controls and reliable accuracy.</p>
    ...
    <div class="tab-content p-0 pt-0 p-5">
      ...
      <div role="tabpanel" class="tab-pane fade show active container" id="tab3-1">
        ...
        <p class="mb-4">
          The NC Press Brake is a high-performance metal bending machine built for precision and productivity. It
          features a robust H-frame structure, hydraulic power, and a CYBELEC controller from Switzerland. The machine
          supports advanced X and Y-axis control, enabling accurate back gauge positioning and bending angles with
          ±0.1mm accuracy. It offers fast setup, programmable operations, and can store up to 200 programs and 50 tool
          configurations, making it ideal for both batch and custom jobs.
        </p>
        ...
        <ul class="list-unstyled">
          <li><i class="bi bi-star-fill text-theme me-2"></i>Touch screen Press Brake controller from CYBELEC
            Switzerland.</li>
          ...
          <li><i class="bi bi-star-fill text-theme me-2"></i>Two-axis automatic control – Y-Axis (bending) & X-Axis
            (back gauge).</li>
          <li><i class="bi bi-star-fill text-theme me-2"></i>Multiple bends with programmable back gauge positions.</li>
          <li><i class="bi bi-star-fill text-theme me-2"></i>200 programs & 24 bends with individual back gauge
            positions per program.</li>
      ...
      <div class="container my-5">
        <div class="row g-4 justify-content-center">
          ...
          <div class="col-md-4">
            <div class="border border-danger rounded p-3 text-center">
              <img src="images/service/Schneider_electrical_components.png" class="img-fluid mb-3"
                alt="Schneider Electrical Components">
      ...
      <div class="container my-4">
        <div class="equipment-section border p-4">
          ...
          <ul class="list-unstyled mb-0">
            ...
            <li><i class="bi bi-check2-circle text-success me-2"></i>HIWIN Ball screws & Polished rod with 0.01 mm
              accuracy</li>
            ...
            <li><i class="bi bi-check2-circle text-success me-2"></i>Giovenzana, Italy Electronic Foot Switch and limit
              switches</li>
          </ul>
        </div>
      </div>
