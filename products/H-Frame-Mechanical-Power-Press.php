        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-7 col-md-6 mt-5 mt-md-0 ps-lg-5">
            <div class="product-details">
              ...
              <p>High-performance H Frame Mechanical Power Press, engineered for precision, durability, and heavy-duty
                metal forming. Ideal for industrial stamping, punching, and pressing applications.</p>
            ...
            <div class="tab">
              ...
              <div class="tab-content p-0 pt-5">
                <div role="tabpanel" class="tab-pane fade show active" id="tab3-1">
                  ...
                  <p class="mb-0">The H Frame Mechanical Power Press is a robust and precision-engineered machine
                    designed for heavy-duty metal forming tasks. With its solid H-frame structure, it ensures stability,
                    high performance, and consistent output in industrial operations. Ideal for punching, bending, and
                    pressing applications, this power press combines durability with efficiency, making it a reliable
                    choice for manufacturing units seeking long-term productivity and minimal maintenance.</p>
                </div>
