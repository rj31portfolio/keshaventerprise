            ...
            <div class="col-lg-3 col-md-6 mb-4">
              <div class="reel-container">
                ...
                <div class="reel-overlay">
                  ...
                  <p class="reel-description">high-performance hydraulic press brakes for precise metal bending and
                    forming in industrial applications.</p>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              <div class="reel-container">
                ...
                <div class="reel-overlay">
                  ...
                  <p class="reel-description">High-performance C Frame Mechanical Power Press Machine for precision
                    metal stamping and forming. Durable, efficient, and ideal for industrial applications.</p>
            ...
            <div class="col-lg-3 col-md-6 mb-4">
              <div class="reel-container">
                ...
                <div class="reel-overlay">
                  ...
                  <p class="reel-description">Efficient Hinges Manufacturing Machine for precision forming and
                    high-volume production. Ideal for producing durable door and cabinet hinges with accuracy.</p>
          ...
          <div class="row align-items-center justify-content-between">
            ...
            <div class="col-lg-6 col-12 pe-md-8">
              <div class="theme-title">
                ...
                <p>Established in 1989, <strong>Keshav Enterprises</strong> based in New Delhi, has emerged as a trusted
                  name in the field of industrial machines and power press manufacturing. We specialize in producing
                  high-performance <strong>Shearing Machines</strong>, <strong>Hydraulic Press Brakes</strong>, and
                  <strong>Hinge Machinery</strong> that meet global standards.</p>
                <p>Our solutions are tailored to match the specific needs of clients across industries, offering the
                  perfect balance of performance, durability, and cost-efficiency. With a focus on customization,
                  communication, and commitment, we have built strong relationships with clients in India and abroad,
                  including exports to the USA, UK, and Central Asia.</p>
              </div>
              ...
              <a class="themeht-btn primary-btn" href="contact.php"><span>Contact Us</span><i
                  class="flaticon flaticon-double-chevron"></i></a>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container">
          <div class="row justify-content-between">
            <div class="col-lg-5 col-md-12">
              ...
              <p class="text-white mb-5">Our industrial service specializes in maximizing machinery performance and
                lifespan. With expert maintenance, timely repairs, and custom solutions, we address your unique
                operational needs all your industrial.</p>
              ...
              <h6 class="ht-heading mb-0 mt-8 text-white">Have Any Question ? Call us Free: <a
                  class="text-theme text-decoration-underline fw-bold" href="tel:+919873673917">+91 9873673917</a>
              </h6>
            </div>
                ...
                <form id="contact-form" method="post" action="submit.php">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <input id="form_email" type="email" name="email" class="form-control"
                          placeholder="Enter Email Address" required="required" data-error="Valid email is required.">
                        <div class="help-block with-errors"></div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <input id="form_phone" type="tel" name="phone" class="form-control"
                          placeholder="Enter Phone number" required="required" data-error="Phone is required">
                        <div class="help-block with-errors"></div>
                      </div>
                    </div>
                    <div class="col-md-6">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-12 mt-3">
                      <button type="submit" class="themeht-btn dark-alt w-100"> <span>Send Message</span> <i
                          class="flaticon flaticon-double-chevron"></i></button>
                    </div>
                  </div>
                </form>
              </div>
      ...
      <section class="d-none p-0">
        <div class="container-fluid p-0">
          <div class="row align-content-end">
            <div class="col-lg-6 col-md-12 bg-pos-cr bg-img-sec testimonial-left-sec position-relative"
              data-bg-img="images/bg/04.jpg">
                  ...
                  <div class="swiper-slide">
                    <div class="testimonial style-3">
                      <div class="testimonial-content">
                        ...
                        <p>I feel very happy and be proud to connect with absolute industry. Pure presume this is a very
                          productive and perfect professional industry. I wish very good luck & success for this
                          industry. Through it examine express He completed the work efficiently and triple checked.</p>
                      </div>
